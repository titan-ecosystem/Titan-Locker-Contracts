// Updates TitanLockerManagerV2_1's fee configuration.
// Usage: npx hardhat run scripts/setFeesV2_1.js --network <network>
...
const NEW_ETH_FEE = hre.ethers.utils.parseEther("0.025");
